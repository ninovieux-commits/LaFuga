...
# Injecter l'icône de notification (blanche) dans res/drawable/notif_icon.png
android.add_resources = icon_notif.png:drawable/notif_icon.png
# Injecter dans <application> : le service FCM + l'icône de notif par défaut
android.extra_manifest_application_arguments = manifest_app.xml
